...
public class Main{
    ...
    public void add() {
    String insertsql = "INSERT INTO inventory_system (product_name, product_quantity, product_price) VALUES (?, ?, ?)";
    ...
    public void view(){
        String selectsql = "SELECT * FROM inventory_system";
        try {
    ...
    public void update() {
    String updatesql = "UPDATE inventory_system SET product_name=?, product_quantity=?, product_price=? WHERE product_id=?";
    ...
    public void delete(){
        String deletesql = "DELETE FROM inventory_system WHERE product_id=?";
        try {
